...
//-----------------
	...
	console.log(coord);
//-------------------------------------------from here		
list_wikipedia_poi(position.coords.latitude,position.coords.longitude);		  
...
console.log(map_center);
        // callback
list_wikipedia_poi(map_center['lat'],map_center['lng']);
...
function list_wikipedia_poi(lat,long)
{
var coord=lat+"%7C"+long;
...
var mGreen = L.marker([lat,long]).bindPopup('Your location').addTo(map);
